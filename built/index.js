...
define("app/views/controls-view", ["require", "exports", "backbone.marionette", "backbone"], function (require, exports, backbone_marionette_2, backbone_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ControlView extends backbone_marionette_2.default.View {
        constructor(options = {}) {
            super(options);
            this.template = _.template(`<div class="control-view"><div class="control-view-body"><%= id %></div><div class="children"></div></div>`);
            this.addRegions({
                "children": {
                    el: ".children",
                    replaceElement: true,
    ...
    class ControlsView extends backbone_marionette_2.default.CollectionView {
        ...
        buildChildView(model, ChildViewClass = ControlView, childViewOption) {
